        ...
        1449: function(t, e, n) {
            ...
            (function(t) {
                ...
                function r(t) {
                    ...
                    function s() {
                        t(this).is(":checked") ? t("<input>").attr({
                            type: "hidden",
                            value: t(this).val(),
                            name: "ship_to_different_address"
                        }).prependTo("form.checkout") : t("input[type=hidden][name='ship_to_different_address']").remove()
                    }
                    ...
                    u.init(), f.init(),
                        function e() {
                            t(".et_pb_wc_checkout_billing form.checkout").length ? (o.isVB && t(".et_pb_wc_checkout_billing form.checkout").prepend('\n        <div class="woocommerce-NoticeGroup woocommerce-NoticeGroup-checkout">\n          <ul class="woocommerce-error" role="alert">\n            <li data-id="billing_first_name">\n              <strong>Billing First name</strong> is a required field.\n            </li>\n          </ul>\n        </div>\n        '), clearTimeout(d)) : d = setTimeout(e, 1e3)
                        }(), t(document.body).on("updated_checkout", p), t("#et-boc").on("change", "input.input-radio", p), t(document.body).on("click", ".woocommerce-cart-form .product-remove > a", (function(t) {
                            ...
                            n() || (t(document.body).on("checkout_error", (function() {
                                ...
                                var n = [],
                                    ...
                                    o = i.is(":checked"),
                                    r = [];
                                o && (n.push("shipping_first_name"), n.push("shipping_last_name"), n.push("shipping_company"), n.push("shipping_address_1"), n.push("shipping_address_2"), n.push("shipping_city"), n.push("shipping_postcode"), t("<input>").attr({
                                    type: "hidden",
                                    value: i.val(),
                                    name: "ship_to_different_address"
                                }).prependTo("form.checkout")), (0, a.default)(["billing_first_name", "billing_last_name", "billing_company", "billing_address_1", "billing_address_2", "billing_city", "billing_postcode", "billing_phone", "billing_email"], (function(e) {
                                ...
                                })), o && r.push("shipping_country"), (0, a.default)(["billing_country"], (function(e) {
                                ...
                                var s = [];
                                if (s.push("billing_state"), o && s.push("shipping_state"), (0, a.default)(s, (function(n) {
                                        var i, a, o = "billing_state" === n ? "et_pb_wc_checkout_billing" : "et_pb_wc_checkout_shipping",
